...
when defined(BGFX_SHARED_LIB):
    ...
    {.passC: "-I/usr/local/include -DBGFX_CONFIG_MULTITHREDED=0 -DBX_CONFIG_ENABLE_MSVC_LEVEL4_WARNINGS=1 -D__STDC_LIMIT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_CONSTANT_MACROS".}
    {.passL: "-lstdc++".} 
    when defined(linux):
        {.passC: "-std=c++11".} 
